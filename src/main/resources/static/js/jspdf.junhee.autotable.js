...
exports.getTheme = function (name) {
    var themes = {
        'striped': {
            ...
            header: { textColor: 80, fillColor: 245, fontStyle: 'bold' },
            body: {},
            alternateRow: { fillColor: 245 }
        },
        'grid': {
            table: { fillColor: 255, textColor: 80, fontStyle: 'normal', lineWidth: 0.1 },
            header: { textColor: 80, fillColor: 255, fontStyle: 'bold', lineWidth: 0 },
            body: {},
            alternateRow: {}
        },
        'plain': {
            table: { fontStyle: 'bold' }
        },
        'dark': {
            table: { fillColor: 255, textColor: 0, fontStyle: 'bold'},
            header: { fillColor: 255, textColor: 0, fontStyle: 'bold'},
            body: { fillColor: 150, textColor: 0, fontStyle: 'bold'}
        }
    };
    return themes[name];
};
